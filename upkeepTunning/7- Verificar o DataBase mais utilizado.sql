--------------------------------------------------------------
--Verifica as databases mais utilizadas do seu banco de dados
--  Essa query você pode ordenar por leitura(num_of_reads) e/ou escrita (num_of_writes) para analisar os arquivos que mais 
